                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             <h3>Processed Admissions</h3>
								<a href="admissions/processed.xls" class="btn btn-primary btn-lg"  onClick="save();">Export To XLS</a>
									<?php include("excel.php"); listOfProcessedAdmissions(); ?>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										<?php
										include('conn.php');
										$fetch_basic_profile="select * from tbl_enquiry where status='Processed' order by id asc";	
